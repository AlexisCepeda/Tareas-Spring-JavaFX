...
public class IndexControlador implements Initializable {
    ...
    public void agregarTarea(){
        if (idTareaInterno != null) {
            mostrarMensaje("Error: Tarea selecionada", "Debe limpiar la tarea actual");
            return;
        }
    ...
    public void eliminarTarea(){
        var tarea = tareaTabla.getSelectionModel().getSelectedItem();
        if (tarea != null){
            logger.info("\nRegistro a eliminar: " + tarea.toString());
            tareaServicio.eliminarTarea(tarea);
            mostrarMensaje("Informacion", "Tarea "+ tarea.getIdTarea() + " eliminada");
            limpiarFormulario();
            listarTareas();
        }
        else {
